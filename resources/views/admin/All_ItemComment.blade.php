                    ...
                    <form action="/admin/All_ItemComment/Search" method="get">
                        <div class="input-group">
                            <input type="text" class="form-control"
                                   placeholder="Item Comment Id/ Item Id / Item Name / User Id / User Name / Updater Id / View"
                                   name="keyword">
                            <div class="input-group-append">
                                ...
                                <div class="dropdown-menu">
                                    <button class="dropdown-item" value="item_comments.itemcommentid"
                                            name="searchclumn">Item Comment Id
                                    </button>
                                    <button class="dropdown-item" value="item_comments.itemid" name="searchclumn">Item
                                        Id
                                    </button>
                                    <button class="dropdown-item" value="items.name" name="searchclumn">Item Name
                                    </button>
                                    <button class="dropdown-item" value="item_comments.userid" name="searchclumn">User
                                        Id
                                    </button>
                                    <button class="dropdown-item" value="users.name" name="searchclumn">User Name
                                    </button>
                                    <button class="dropdown-item" value="item_comments.updaterid" name="searchclumn">
                                        Updater Id
                                    </button>
                                    <button class="dropdown-item" value="item_comments.view" name="searchclumn">View
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <tr>
                                ...
                                <th class="text-center">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <button class="dropdown-item" value="item_comments.created_at"
                                                    name="dateclumn"
                                                    type="submit">Created
                                            </button>
                                            <button class="dropdown-item" value="item_comments.updated_at"
                                                    name="dateclumn"
                                                    type="submit">Updated
                                            </button>
                                        </div>
